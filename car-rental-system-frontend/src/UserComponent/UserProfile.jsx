        ...
        >
          <div className="card-body header-logo-color">
            ...
            <div className="row mt-2">
              <div className="col-md-4">
                <p className="mb-2">
                  <b className="text-color">Phone Number:</b> {user.phoneNo}
                </p>
              </div>
              <div className="col-md-4">
                <p className="mb-2">
                ...
                return (
                  <div>
                    <div className="row mt-4">
                      <div className="col-md-4">
                        <p className="mb-2">
                          <b className="text-color">Driving License Number:</b>{" "}
                          {user.license.licenseNumber}
                        </p>
                      </div>
                      <div className="col-md-4">
                        <p className="mb-2">
                          <b className="text-color">Expiration Date:</b>{" "}
